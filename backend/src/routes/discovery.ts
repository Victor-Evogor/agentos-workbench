...
type DiscoveryWorkbenchMode = 'mixed';

export const WORKBENCH_DISCOVERY_MODE_HEADER = 'X-AgentOS-Workbench-Mode';

function markDiscoveryReply(reply: FastifyReply, mode: DiscoveryWorkbenchMode = 'mixed'): void {
  reply.header(WORKBENCH_DISCOVERY_MODE_HEADER, mode);
}
      ...
      schema: {
        ...
        querystring: {
          ...
          properties: {
            ...
            kind: {
              type: 'string',
              description: 'Filter by kind: tool | skill | extension | channel',
            },
        ...
        response: {
          200: {
            ...
            required: ['mode', 'capabilities', 'total'],
          },
        },
      },
    },
