...
const COMMANDS: CommandItem[] = [
  ...
  { key: 'marketplace', label: 'Marketplace', description: 'Discover and install templates, workflows, and extensions', icon: <Store className="h-4 w-4" />, keywords: ['registry', 'install', 'browse'] },
  ...
  { key: 'capabilities', label: 'Capability Browser', description: 'Search tools, skills, and extensions', icon: <Package className="h-4 w-4" />, keywords: ['capabilities', 'extensions', 'skills', 'tools'] },
  { key: 'rag', label: 'RAG Workspace', description: 'Retrieval settings, documents, and search', icon: <FileUp className="h-4 w-4" />, keywords: ['rag', 'documents', 'upload', 'retrieval', 'config', 'search'] },
  ...
  { key: 'settings', label: 'Settings', description: 'Runtime, guardrails, skills, and secrets', icon: <Wrench className="h-4 w-4" />, keywords: ['runtime', 'settings', 'secrets'] },
  { key: 'about', label: 'About', description: 'Workbench overview and reference links', icon: <Info className="h-4 w-4" />, keywords: ['about', 'help', 'reference'] },
];
